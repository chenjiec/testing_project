...
rm -rf $LIB_PATH
rm -rf ${LIB_PATH}_gate

vlib $LIB_PATH
vmap $LIB_NAME $LIB_PATH
vlib ${LIB_PATH}_gate
vmap ${LIB_NAME}_gate ${LIB_PATH}_gate
...
vlog -quiet -sv -suppress 2583 -work ${LIB_PATH}    +incdir+${IP_PATH}/include ${IP_PATH}/riscv_simchecker.sv || goto error

# GATE LEVEL
vlog -quiet -work ${LIB_PATH}_gate ${PULP_PATH}/asic/techlib/NangateOpenCellLibrary.v
vlog -quiet -work ${LIB_PATH}_gate ${PULP_PATH}/asic/synopsys/out/final_riscv_core.v
